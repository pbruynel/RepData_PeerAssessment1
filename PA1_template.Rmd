...
```
The mean of the total number of steps taken per day is: `r format(meanSteps_PerDay, digits=2, nsmall=2)`  
The median of the total number of steps taken per day is: `r medianSteps_PerDay`
...
```
The maximum average number of steps that have been taken in an interval: `r format(max_average, digits=2, nsmall=2)`  
The interval where the maximum average number of steps have been taken is: `r max_interval`  
...
```
The number of missing values in the original dataset is `r total_NAs`  
...
```
The number of missing values in the newly created dataset is `r total_NAs`  
...
- Mean: `r format(meanSteps_PerDay, digits=2, nsmall=2)`  
- Median: `r format(medianSteps_PerDay, digits=2, nsmall=2)`  
Mean and median after replacing missing values:  
- Mean: `r format(meanSteps_PerDay_NoNAs, digits=2, nsmall=2)`  
- Median: `r format(medianSteps_PerDay_NoNAs, digits=2, nsmall=2)`  
